...
urlpatterns = [
    ...
    path('activity/<int:pk>/import-to-current-year/', schedule_views.import_activity_to_current_year, name='import_activity_to_current_year'),
    path('activity/import-subject/<int:subject_id>/', schedule_views.import_subject_activities, name='import_subject_activities'),
