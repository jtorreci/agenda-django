...
if DEBUG:
    ...
    CSRF_COOKIE_HTTPONLY = False  # Permite debugging y acceso JavaScript
    SESSION_COOKIE_HTTPONLY = True  # Protege sesiones incluso en desarrollo
    ...
    CSRF_COOKIE_HTTPONLY = True   # Máxima seguridad contra XSS
    SESSION_COOKIE_HTTPONLY = True  # Protege sesiones contra XSS
